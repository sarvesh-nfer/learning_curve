...
def PopulateResultTable(input_folder_path, output_path,tableTag):
  ...
  for item in input_list:
    try:
      ...
      path1 = slide_path+"/whiteCorrectedInput.png"
      path2 = slide_path+"/debug_folder2/total_coverslip_lines.jpeg"
      tableTag = tableTag + "<th>SlideName</th><th>vawhiteCorrectedInputlues</th><th>total_coverslip_lines</th>"
