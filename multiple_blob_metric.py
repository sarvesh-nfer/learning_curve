...
def populateFocusColorMetricValuesFromDB(slide_path):
        ...
        for sar in grid_path:
            ...
            out_path = os.path.join(sar, "20x_fm_cm_hm_2")
            ...
            for item in list_dir:
                ...
                blob_index_list.append(df[(df['grid_id'] == _grid_id) & (df['aoi_name'] == aoi_name)]['blob_index'].to_list())
                fm_list_data.append(df[(df['grid_id'] == _grid_id) & (df['aoi_name'] == aoi_name)]['focus_metric'].to_list())
                cm_list_data.append(df[(df['grid_id'] == _grid_id) & (df['aoi_name'] == aoi_name)]['color_metric'].to_list())
                stack_index_list.append(df[(df['grid_id'] == _grid_id) & (df['aoi_name'] == aoi_name)]['stack_index'].to_list())
                hue_metric_list.append(df[(df['grid_id'] == _grid_id) & (df['aoi_name'] == aoi_name)]['hue_metric'].to_list())
                    # print(_vals) 
...
path = "/home/adminspin/Downloads/validation"
