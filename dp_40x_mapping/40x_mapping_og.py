...
if __name__ == '__main__':
    ...
    for slide in input_list:
        try:
            input_path = os.path.join('/datadrive/wsi_data/onex_images',slide)
            ...
            print('images saved for slide :',slide)
        except:
            print("ERROR occured for slide :",slide)
